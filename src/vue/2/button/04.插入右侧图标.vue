...
<template>
    <Button content-class="gap-2"
        ...
        <template #rightIcon>
            <svg t="1750387235389" class="icon w-4 h-4" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="5161" width="200" height="200">
                <path
                    ...
                    fill="currentColor" p-id="5162"></path>
                <path
                    ...
                    fill="currentColor" p-id="5163"></path>
            </svg>
        </template>
        上传
    </Button>
